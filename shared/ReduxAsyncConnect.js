...
export default class ReduxAsyncConnect extends Component {
  ...
  async componentWillReceiveProps(nextProps) {
    ...
    if (navigated) {
      ...
      // ensure all data for routes is prefetched before rendering
...
//     { [Function: Route]
//       propTypes:
//        { computedMatch: { [Function: shim] isRequired: [Circular] },
//          path: { [Function: shim] isRequired: [Circular] },
//          exact: { [Function: shim] isRequired: [Circular] },
//          strict: { [Function: shim] isRequired: [Circular] },
//          sensitive: { [Function: shim] isRequired: [Circular] },
//          component: { [Function: shim] isRequired: [Circular] },
//          render: { [Function: shim] isRequired: [Circular] },
//          children: { [Function: shim] isRequired: [Circular] },
//          location: { [Function: shim] isRequired: [Circular] } },
//       contextTypes: { router: { [Function: shim] isRequired: [Circular] } },
//       childContextTypes: { router: { [Function: shim] isRequired: [Circular] } } },
//    key: null,
//    ref: null,
//    props:
